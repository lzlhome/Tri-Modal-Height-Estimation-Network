...
def deeplabv3_resnet50(aux, in_channel = 3, num_classes=1, pretrain_backbone=False):
    # 'resnet50_imagenet': 'https://download.pytorch.org/models/resnet50-0676ba61.pth'
    # 'deeplabv3_resnet50_coco': 'https://download.pytorch.org/models/deeplabv3_resnet50_coco-cd0a2569.pth'
    backbone = resnet50(in_channel=in_channel, replace_stride_with_dilation=[False, True, True])
...
def deeplabv3_resnet101(aux, num_classes=1, pretrain_backbone=False):
...
def deeplabv3_mobilenetv3_large(aux, num_classes=1, pretrain_backbone=False):
